...
class JCircularMenu: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        inset2 =  UIEdgeInsets(top: newHeight *  insetPourcent2,left: newHeight *  insetPourcent2,bottom: newHeight *  insetPourcent2,right: newHeight *  insetPourcent2)
        inset = UIEdgeInsets(top: newHeight *  insetPourcent,left: newHeight *  insetPourcent,bottom: newHeight *  insetPourcent,right: newHeight *  insetPourcent)
    ...
    @objc func delegateMethod(_ sender: UIButton){
